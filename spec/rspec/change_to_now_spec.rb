  ...
  describe Matchers::BuiltIn::Change do
    describe "#to_now" do
      ...
      it "fails without an expectation block" do
        ...
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /was not given a block/)
      end
      it "fails when the argument is not a matcher" do
        expect {
          expect { }.to change { number }.to_now 2
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /to be a matcher but got/)
      end
      it "fails when the final expectation is never met" do
        ...
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /After the change.*got: 2/m)
      end
      it "fails when the final expectation is already met" do
        ...
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Before the change.*got: 2/m)
      end
    end
    ...
    describe "#not_to" do
      ...
      it "fails when there is no change" do
        ...
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /did not change/)
      end
      it "fails when the final expectation is already met" do
        number = 2
        expect {
      ...
      it "fails when the final expectation is never met" do
        ...
        }.to raise_error(RSpec::Expectations::ExpectationNotMetError, /After the change.*not to satisfy/m)
      end
    end
